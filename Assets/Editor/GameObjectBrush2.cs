...
namespace UnityEditor.Tilemaps
{
    ...
    [CustomGridBrush(true, false, false, "GameObject Brush 2")]
    public class GameObjectBrush2 : GridBrushBase
    {
        [Serializable]
        ...
        public void ForceCurrentCell()
        {
            for (int i = 0; i < m_Cells.Length; i++)
            {
                m_Cells[i].gameObject = cell;
    ...
    /// </summary>
    [CustomEditor(typeof(GameObjectBrush2))]
    public class GameObjectBrushEditor : GridBrushEditorBase
    {
        ...
        /// </summary>
        public GameObjectBrush2 brush { get { return target as GameObjectBrush2; } }
